...
st.set_page_config( page_title= 'Finance Company : Credit Risk Modeling', page_icon="📊")
st.title('Finance Company : Credit Risk Modeling')
...
with row2[1]:
    loan_tenure_months = st.number_input('Loan Tenure (months)', min_value=0, step=1, max_value=36)
