...
def prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_deliquency,
...
def predict(age, income, loan_amount, loan_tenure_months,  avg_dpd_per_deliquency,
            delinquency_ratio, credit_utilization_ratio, num_open_accounts,
            residence_type, loan_purpose, loan_type):
    input_df = prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_deliquency,
                             delinquency_ratio, credit_utilization_ratio, num_open_accounts,
                             residence_type, loan_purpose, loan_type)
...
def calculate_credit_score(input_df , base_score = 300 , scale_length = 600):
    ...
    #Apply the logistic function to calculate probability
    default_probability = 1/ (1+np.exp(-x))

    non_default_probability = 1- default_probability

    # Convert Probability of credit score, scaled to fit withi 300 to 900
